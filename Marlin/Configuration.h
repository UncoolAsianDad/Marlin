...
#define STRING_CONFIG_H_AUTHOR "Voron 0, MKS GEN_L V2.1" // Who made the changes.
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  26.48,  26.48 }
    #define DEFAULT_Ki_LIST {   2.18,   2.18 }
    #define DEFAULT_Kd_LIST {  80.27,  80.27 }
  #else
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 92.56
  #define DEFAULT_bedKi 13.29
  #define DEFAULT_bedKd 429.66
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_TYPE          NEO_RGB // MKS Mini12864 V3 (FYSETC 2.1) — required by SanityCheck
                                          // See https://github.com/adafruit/Adafruit_NeoPixel/blob/master/Adafruit_NeoPixel.h
  //#define NEOPIXEL_PIN                4 // Set by board pins for MKS_MINI_12864_V3 (EXP1_06 on RAMPS)
  //#define NEOPIXEL2_TYPE  NEOPIXEL_TYPE
  //#define NEOPIXEL2_PIN               5
  #define NEOPIXEL_PIXELS               3 // Mini12864 V3 RGB bar
