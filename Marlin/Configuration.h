...
#define STRING_CONFIG_H_AUTHOR "(Brian Ho, BigTreeTech SKR v1.3 Delta Printer)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "G2S Pro 3D Printer with SKR v1.3 Probe"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "72130208-7b2d-4619-93ba-0cf240b41f7c"
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  // #define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  12.82,  12.82 }
    #define DEFAULT_Ki_LIST {   0.52,   0.52 }
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 45.38
  #define DEFAULT_bedKi 1.11
  #define DEFAULT_bedKd 1237.29
...
#define DELTA
  ...
  #define DELTA_HEIGHT 191.59             // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { -0.11, 0.0, -0.78 } // (mm) Get these values from G33 auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 92.43              // (mm) Get this value from G33 auto calibrate
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 34.64, -20, -2 } // G2 { 19, -11, -2 }
