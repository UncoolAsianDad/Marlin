...
#define DELTA
  ...
  #define DELTA_PRINTABLE_RADIUS 83.0    // (mm)

  // Maximum reachable area
  #define DELTA_MAX_RADIUS       83.0    // (mm)

  // Center-to-center distance of the holes in the diagonal push rods.
  #define DELTA_DIAGONAL_ROD 186.0        // (mm)

  // Distance between bed and nozzle Z home position
  #define DELTA_HEIGHT 190.00             // (mm) Get this value from G33 auto calibrate
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 6.94, -44.46, -2 }
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_BRIGHTNESS         8 // Initial brightness (0-255)
