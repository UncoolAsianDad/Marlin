...
//#define LCD_BACKLIGHT_TIMEOUT_MINS 1  // (minutes) Timeout before turning off the backlight
  ...
  #define LED_CONTROL_MENU
    ...
    //#define NEO2_COLOR_PRESETS              // Enable a second NeoPixel Preset Color menu option
      ...
      #define LED_USER_PRESET_STARTUP         // User preset color on startup (MKS Mini12864 V3 NeoPixels)
    #endif
 ...
 */
   ...
   */
  #if HAS_STEALTHCHOP
    // XY: SpreadCycle only — TMC2208 StealthChop often jitters/stutters on CoreXY; chopper is tuned via CHOPPER_TIMING.
   ...
   */
  #define CHOPPER_TIMING CHOPPER_DEFAULT_24V        // Match motor supply (VMOT to steppers)
  ...
  // TMC2208: full-time StealthChop on XY often jitters; switch to SpreadCycle above these speeds (tune with M913).
